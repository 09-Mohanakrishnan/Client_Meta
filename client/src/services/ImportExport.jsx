...
import { Download, Upload, AlertTriangle, CheckCircle, AlertOctagon, FileText, Check } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2">
        <label className="flex items-center gap-1.5 rounded border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 px-3 py-1.5 text-xs font-semibold shadow-sm cursor-pointer transition-colors">
